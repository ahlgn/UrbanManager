...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        String packageName = "cn.urban.system";
        String[] tableNames = {"sys_authorities","sys_role_authorities"};
    ...
    public static void generateByTables(boolean serviceNameStartWithI, String packageName, String... tableNames) {
        ...
        gc.setOutputDir("/Users/panda/workspace/JavaDemo/UrbanManager/src/main/java/");  // 输出位置
        ...
        dsc.setUrl("jdbc:mysql://47.103.1.87:3306/urban_manager");
